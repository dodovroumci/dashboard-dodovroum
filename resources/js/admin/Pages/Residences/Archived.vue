  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div class="min-w-0">
        <div class="flex items-center gap-2 mb-1">
          <a href="/admin/residences" class="text-sm text-slate-500 hover:text-slate-700 flex items-center gap-1 transition-colors">
            <ChevronLeft class="w-4 h-4" />
            Résidences
          </a>
        </div>
        <h1 class="text-xl sm:text-2xl font-bold text-slate-900">Résidences archivées</h1>
        <p class="text-sm text-slate-500 mt-0.5">Toutes les résidences désactivées sur la plateforme</p>
      </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl overflow-hidden">
      ...
      <div v-if="residences.length === 0 && !error" class="p-12 text-center">
        ...
        <p class="text-slate-500 mb-4">Les résidences désactivées apparaîtront ici.</p>
        <a
        ...
        <table class="w-full">
          <thead class="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Propriétaire</th>
          ...
          <tbody class="divide-y divide-slate-200">
            ...
            >
              ...
              <!-- Propriétaire -->
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="text-sm text-slate-600">{{ residence.ownerName || '—' }}</span>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right" @click.stop>
                <div class="flex items-center justify-end gap-2">
                  ...
                  <form :action="`/admin/residences/${residence.id}/reactivate`" method="POST">
      ...
      <Pagination
        ...
        route-name="admin.residences.archives"
        :filters="{}"
      />
    </div>
  </div>
