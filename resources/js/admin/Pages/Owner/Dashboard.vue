  ...
  <div class="space-y-6">
    ...
    <section class="bg-white border border-slate-200 rounded-2xl p-6">
      <div class="flex items-center justify-between mb-4">
        <h2 class="text-lg font-semibold text-slate-900">Réservations récentes</h2>
        <Link
          href="/owner/bookings"
      ...
      <section class="bg-white border border-slate-200 rounded-2xl p-6">
        ...
        <div class="space-y-4">
          ...
          <div v-if="stats.residences.last" class="pt-4 border-t border-slate-200">
            ...
            <Link
              :href="`/owner/residences/${stats.residences.last.id}`"
      ...
      <section class="bg-white border border-slate-200 rounded-2xl p-6">
        ...
        <div class="space-y-4">
          ...
          <div v-if="stats.vehicles.last" class="pt-4 border-t border-slate-200">
            ...
            <Link
              :href="`/owner/vehicles/${stats.vehicles.last.id}`"
              class="text-sm font-medium text-blue-600 hover:text-blue-700"
            >
    ...
    <!-- Raccourcis rapides -->
    <section class="bg-white border border-slate-200 rounded-2xl p-6">
      <h2 class="text-lg font-semibold text-slate-900 mb-4">Raccourcis rapides</h2>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <span class="text-sm font-medium text-slate-700">Contacter le support</span>
        </a>
      </div>
    </section>
  </div>
