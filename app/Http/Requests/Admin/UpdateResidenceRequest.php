...
class UpdateResidenceRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        if (method_exists($user, 'isAdmin')) {
            ...
            \Illuminate\Support\Facades\Log::debug('🔵 UpdateResidenceRequest::authorize - Résultat isAdmin()', [
                'isAdmin' => $isAdmin,
        ...
        \Illuminate\Support\Facades\Log::debug('🔵 UpdateResidenceRequest::authorize - Résultat fallback', [
            'role' => $role,
